...
const baseSpeed = 0.01; // lower = slower base velocity
const rangeSpeed = 0.1; // lower = less variance, overall slower feel
const baseTTL = 220; // longer lifetime to avoid frequent respawn jitter
const rangeTTL = 300;
