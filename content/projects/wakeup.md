...
<div class="product-screens">
  <figure>
    ...
    <figcaption>Onboarding · the wake-up contract</figcaption>
  </figure>
  <figure>
    <img src="/projects/wakeup/screens/02-list-empty.jpeg" alt="Empty alarm list with a gradient + button" />
    <figcaption>Alarm list · empty state</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>New alarm · time / repeat / label / ringtone</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>Camera target · today's draw is the toilet</figcaption>
  </figure>
  <figure>
    ...
    <figcaption>Miss · try again</figcaption>
  </figure>
</div>
